$.fn.selectAddress = function () {
    ...
    $("#province").click(function () {
        ...
        for (var m = 0; m < provinceList.length; m++) {
            if (province == provinceList[m].name) {
                ...
                for (var n = 0; n < provinceList[m].cityList.length; n++) {
    ...
    $("#city").click(function () {
        ...
        if (province != '') {
            ...
            for (var x = 0; x < cityItems.cityList.length; x++) {
                if (city == cityItems.cityList[x].name) {
                    townItems = cityItems.cityList[x].areaList
                    for (var y = 0; y < townItems.length; y++) {
...
$.fn.setAddress = function (val){
    ...
    if(arr.length == 3){
        ...
        $("#province").html(html);
        $("#province").val(arr[0]);
        var list = getList(provinceList,arr[0]);
        var areaArr = [];
        html="";
        ...
        for (var i = 0; i < areaArr.length; i++) {
            html += "<option value=\""+areaArr[i]+"\">"+areaArr[i]+"</option>";
        }
        $("#town").html(html);
        $("#town").val(arr[2]);
    }
...
function getList(arr,name) {
    for (var i = 0; i < arr.length; i++) {
        if(name === arr[i].name){
            return arr[i].cityList;
        }
    }
}
...
var provinceList = [{
    ...
    }, {name: '随州市', areaList: ['曾都区', '广水市', '随  县']}, {name: '仙桃市', areaList: ['仙桃市']}, {
        name: '潜江市',
        areaList: ['潜江市']
    }, {name: '天门市', areaList: ['天门市']}, {name: '神农架林区', areaList: ['神农架林区']}, {
        name: '恩施土家族苗族自治州',
        areaList: ['恩施市', '利川市', '建始县', '巴东县', '宣恩县', '咸丰县', '来凤县', '鹤峰县']
    }]
}, {
    name: '湖南',
    cityList: [{name: '长沙市', areaList: ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区', '长沙县', '望城县', '宁乡县', '浏阳市']}, {
        name: '株洲市',
    ...
    name: '安徽',
    cityList: [{name: '合肥市', areaList: ['瑶海区', '庐阳区', '蜀山区', '包河区', '长丰县', '肥东县', '肥西县']}, {
        name: '芜湖市',
    ...
    }, {name: '日照市', areaList: ['东港区', '岚山区', '五莲县', '莒　县']}, {name: '莱芜市', areaList: ['莱城区', '钢城区']}, {
        name: '临沂市',
    ...
    }, {name: '五指山市', areaList: ['市辖区']}, {name: '琼海市', areaList: ['五指山市']}, {
        name: '儋州市',
        areaList: ['儋州市']
    }, {name: '文昌市', areaList: ['文昌市']}, {name: '万宁市', areaList: ['万宁市']}, {
        name: '东方市',
        areaList: ['东方市']
    }, {name: '三沙市', areaList: ['西沙群岛', '南沙群岛', '中沙群岛', '其它海域']}, {name: '定安县', areaList: ['定安县']}, {
        name: '屯昌县',
        areaList: ['屯昌县']
    }, {name: '澄迈县', areaList: ['澄迈县']}, {name: '临高县', areaList: ['临高县']}, {
        name: '白沙黎族自治县',
        areaList: ['白沙黎族自治县']
    }, {name: '昌江黎族自治县', areaList: ['昌江黎族自治县']}, {name: '乐东黎族自治县', areaList: ['乐东黎族自治县']}, {
        name: '陵水黎族自治县',
        areaList: ['陵水黎族自治县']
    }, {name: '保亭黎族苗族自治县', areaList: ['保亭黎族苗族自治县']}, {name: '琼中黎族苗族自治县', areaList: ['琼中黎族苗族自治县']},]
}, {
    name: '香港',
    cityList: [{name: '香港岛', areaList: ['中西区', '东区', '南区', '湾仔区']}, {
        name: '九龙',
        areaList: ['九龙城区', '观塘区', '深水埗区', '黄大仙区', '油尖旺区']
    }, {name: '新界', areaList: ['北区', '离岛区', '西贡区', '沙田区', '大埔区', '荃湾区', '元朗区', '屯门区', '葵青区']}]
}, {
    name: '澳门',
    cityList: [{name: '澳门特别行政区', areaList: ['大堂区', '嘉模堂区', '望德堂区', '花地玛堂区', '路氹填海区', '圣方济各堂区']}]
}, {
    name: '台湾',
    cityList: [{name: '台北区域', areaList: ['台北市', '基隆市', '新北市', '桃园市', '新竹市', '宜兰县', '新竹县']}, {
        name: '台中区域',
        areaList: ['苗栗县', '台中市', '彰化县', '南投县', '嘉义市', '花莲县', '云林县', '嘉义县']
    }, {name: '台南区域', areaList: ['台南市', '高雄市', '台东县', '屏东县']}, {name: '其它区域', areaList: ['澎湖县', '连江县']}]
}];