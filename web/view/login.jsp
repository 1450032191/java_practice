        ...
        <div style="width:422px;height:409px;margin:0 auto;padding:30px;margin-top:5px;background-color:#fff;">
            ...
            <div style="width:100%;height:213px;margin:0 auto;margin-top:68px;">
                <div style="width:362px;height:40px;    border: 1px solid #e6e6e6; margin-bottom:15px;">
                    <label style="width:40px;height:40px;padding:8px;float:left;padding-left:13px;"><i class="glyphicon glyphicon-user" style="font-size: 22px;" aria-hidden="true"></i></label>
                    <input class="form-control user" id="login_name" type="text" placeholder="请输入用户名" style="float:right;width:320px;height:38px;border-radius:0px;outline: none;border-color: #fff;box-shadow: 0 0 5px rgba(207, 220, 0, -2.4);border-radius: 5px;"/>
                </div>
                <div style="width:362px;height:40px;    border: 1px solid #e6e6e6; margin-bottom:15px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="signin-icon-container">
                    ...
                    <input type="text" class="form-control input-lg registeruser" id="re-userName" placeholder="请设置用户名" required autofocus>
                </div>
                <div class="signin-icon-container">
                    <i class="glyphicon glyphicon-modal-window"></i>
                    <label class="sr-only">手机号</label>
                    <input type="text" class="form-control input-lg registeronlinepay" id="re-userPhone" placeholder="请输入手机号" required>
                </div>
                <div class="signin-icon-container">
                    <i class="glyphicon glyphicon-lock"></i>
                    <label class="sr-only">登录密码</label>
                    <input type="password" class="form-control input-lg registerpassword" id="re-userPass" placeholder="请设置密码" required>
                </div>
                <div class="signin-icon-container">
                    <i class="glyphicon glyphicon-lock"></i>
                    <label class="sr-only">登录密码</label>
                    <input type="password" class="form-control input-lg registerpasswordone" id="re-userPass-ag" placeholder="请重新输入密码" required>
                </div>
                <div class="signin-icon-container">
                    <i class="glyphicon glyphicon-envelope"></i>
                    <label class="sr-only">邮箱地址</label>
                    <input type="email" class="form-control input-lg registeremail" id="re-userEmail" placeholder="请设置邮箱地址" required autofocus>
                </div>
            </div>
